...
// Defining `ionicTimepicker` directive
    .directive('ionicTimepicker', ['$rootScope','$ionicPopup', function ($rootScope, $ionicPopup) {
        return {
            restrict: 'AE',
            replace: true,
            scope: {
            ...
            link: function (scope, element, attrs) {
                if(!$rootScope.ionicTimepicker){
                    $rootScope.ionicTimepicker = scope;
                }
                else{
                    $rootScope.ionicTimepicker2 = scope;
                }
